...
function! s:app_tags_command() dict
  ...
  "exe "!".cmd." -f ".s:escarg(self.path("tmp/tags"))." --exclude=facebox.js --exclude=\"*.*.js\" --exclude=\"yui\" --langmap=\"ruby:+.rake.builder.rjs\" -R ".s:escarg(self.path())
...
function! s:SetBasePath()
  ...
  let path += ['app/*', 'vendor', 'vendor/plugins/*/lib', 'vendor/gems/*/lib', 'vendor/gems/*/app', 'vendor/gems/*/app/models', 'vendor/gems/*/app/controllers', 'vendor/gems/*/app/helpers', 'vendor/gems/*/app/views', 'vendor/gems/*/app/models/*', 'vendor/gems/*/app/controllers/*', 'vendor/gems/*/app/helpers/*', 'vendor/gems/*/app/views/*', 'vendor/gems/*/app/views/**', 'vendor/plugins/*/test/*', 'vendor/rails/*/lib', 'vendor/rails/*/test']
